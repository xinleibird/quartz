...
dev: ## Serve Quartz locally
	hugo-obsidian -input=/Users/xinlei/Library/Mobile\ Documents/iCloud~md~obsidian/Documents -output=assets/indices -index -root=. && hugo server --enableGitInfo --minify
